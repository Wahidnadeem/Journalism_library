 ...
 <div class="main-content">
    <div class="container">
                                    ...
                                    <ul id="myTab" class="nav nav-tabs tab-bricky bfont">
                                        <li class="active">
                                            <a href="#panel_tab_1" data-toggle="tab" aria-expanded="true">
                                                <i class="green clip-stack"></i> ثبت کتگوری
                                            </a>
                                        </li>
                                    </ul>
                                            ...
                                            <form role="form" class="form-horizontal bfont" action="action_category.php" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-5 col-xs-12">
                                                        <input type="text" onblur="is_dublicate(this.value,'is_doblicate_category_name')" autocomplete="off" id="name" name="name" required placeholder="مثال : رادیو" class="form-control tooltips" data-placement="top" title="این فیلد لازمی است" data-rel="tooltip" data-original-title="نام کتگوری را وارد کنید">
        ...
        <!-- start: PAGE CONTENT -->
         ...
         <?php
             $record_table = $db->query("SELECT COUNT(id) AS number FROM `categories` WHERE is_deleted = '0' LIMIT $to OFFSET $from ")->fetch(); 
                                            ...
                                            <table class="table table-bordered table-hover" id="sample-table-1" >
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="left bfont">نام کتگوری</th>
                                                            ...
                                                            $action = 
                                                                '<td class="tab-cen center">
                                                                    <div class="visible-md visible-lg hidden-sm hidden-xs">
                                                                        <a href="edit_category.php?id='.base64_encode($rows['id']).'" class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit">
