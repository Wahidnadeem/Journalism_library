...
require_once("_config.php");
    ...
    if (isset($_GET['id'])) {
        ...
        $view            = $db->query("SELECT * FROM `teachers` WHERE `is_deleted` = '0' AND `id`='$id'");
        $teacher_row     = $view->fetch();
    }
?>
                                        ...
                                        <div class="">
                                            <div class="tab-pane active" id="panel_tab_1">
                                                ...
                                                <form role="form" class="form-horizontal bfont" action="action_teacher.php" method="POST" enctype="multipart/form-data">
                                                     ...
                                                     <input type="hidden" name="id" id="id" value="<?php echo base64_encode($teacher_row['id']);?>">
                                                     <input type="hidden" name="lastphoto" value="<?php echo $teacher_row['photo'];  ?>"  >
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-lg-7 col-xs-12">
                                                            <img width="250" src="<?php echo $teacher_row['photo'] ?>" class="thumbnail" id = "old_img" > 
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-lg-7 col-xs-12">
                                                            <input type="number" onblur="is_dublicate(this.value,'is_doblicate_teacher_id','<?php echo $teacher_row['teacher_id']?>')" autocomplete="off" value="<?php echo $teacher_row['teacher_id']?>" id="teacher_id" name="teacher_id" required placeholder="مثال : 100" class="form-control tooltips" data-placement="top" title="این فیلد لازمی است" data-rel="tooltip" data-original-title="نام کامل را وارد کنید">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-lg-7 col-xs-12">
                                                            <input type="text" autocomplete="off" value="<?php echo $teacher_row['full_name']?>" id="full_name" name="full_name" required placeholder="مثال : حمید محمدی" class="form-control tooltips" data-placement="top" title="این فیلد لازمی است" data-rel="tooltip" data-original-title="نام کامل را وارد کنید">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-lg-7 col-xs-12">
                                                            <input type="text" autocomplete="off" value="<?php echo $teacher_row['father_name']?>" id="father_name" name="father_name" required placeholder="مثال : علی احمد" class="form-control tooltips" data-placement="top" title="این فیلد لازمی است" data-rel="tooltip" data-original-title="نام پدر را وارد کنید">
                                                        </div>
                                                    </div>
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-lg-7 col-xs-12">
                                                            <input type="text" autocomplete="off" value="<?php echo $teacher_row['department']?>" id="department" name="department" required placeholder="مثال : 1400" class="form-control tooltips" data-placement="top" title="این فیلد لازمی است" data-rel="tooltip" data-original-title="نام پدر را وارد کنید">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-lg-7 col-xs-12">
                                                            <input type="number" autocomplete="off" value="<?php echo $teacher_row['phone']?>" id="phone" name="phone" required placeholder="مثال : 0799090909" class="form-control tooltips" data-placement="top" title="این فیلد لازمی است" data-rel="tooltip" data-original-title="نام پدر را وارد کنید">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-lg-7 col-xs-12">
                                                            <input type="email" autocomplete="off" value="<?php echo $teacher_row['email']?>" id="email" name="email" required placeholder="مثال : admin@gmail.com" class="form-control tooltips" data-placement="top" title="این فیلد لازمی است" data-rel="tooltip" data-original-title="نام پدر را وارد کنید">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-lg-7 col-xs-12 input-group" style="padding-left:15px !important; padding-right:15px !important;">
                                                            <input type="text" id="date" name="date" value="<?php echo $teacher_row['date']?>" class="form-control tooltips" data-placement="top" title="" data-rel="tooltip" data-original-title="این فیلد لازمی هست" autocomplete="off">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-lg-7 col-xs-12">
                                                            <textarea type="text" id="note" name="note" rows="5" placeholder="این فیلد لازمی  نیست" class="form-control tooltips" data-placement="top" title="این فیلد لازمی نیست" data-rel="tooltip" data-original-title="این فیلد لازمی نیست"><?php echo $teacher_row['note']?></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <div class="col-sm-12 col-md-12 col-lg-6 col-xs-12">
                                                                ...
                                                                <button type="submit" name="edit" class="btn btn-primary fbtn">
                                                                    ...
                                                                    <span class="ladda-label"> ویرتیش  </span>
                                                                </button>
