...
if(!empty($username) && !empty($password) ){
    ...
    $is_user = $db->prepare("SELECT * FROM users WHERE `username` = :username and `password` = :password and is_deleted = 0 limit 1");
    ...
    if($is_user->rowCount() > 0 ){
        ...
        $_SESSION['auth']           = "b58ac01c6c7a9fb5ffd1a5d9c7d68955-afghanVTeam";
